...
function LoginModal({ t, onLogin, close, showSignup, role }) {
  ...
  const emailPh = isNgo ? "hello@ngo.org" : isAdmin ? "you@wastelytics.in" : "you@restaurant.com";
