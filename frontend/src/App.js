...
const copy = {
  en: {
    overview: "Overview", log: "Log surplus", market: "Marketplace", billing: "Billing", sub: "Here’s what your kitchen is telling you this week.", wasted: "Total food wasted", impact: "Cost impact estimate", top: "Top wasted item", trend: "Avg per entry", updated: "Live · updated 2 min ago", insights: "Actionable insights", week: "This week", month: "This month", recent: "Recent logs", viewAll: "View all", add: "Log food waste", recommendations: "Recommendations", marketTitle: "Surplus marketplace", claim: "Claim food", claims: "My claims", liveListings: "Live listings", mapDistance: "Map & distance", verificationStatus: "Verification status", filterAll: "All", filterHigh: "High priority", filterVeg: "Vegetarian", filterCold: "Refrigerated", rescueOpps: "Rescue opportunities", inventoryTitle: "Inventory reorder watch", inventorySub: "Set minimums before a stock gap affects service", expiryTitle: "Expiry watch", expirySub: "Protect margin before food goes out of date", benchmark: "Benchmark", reporting: "Reporting", referSave: "Refer & save", multiOutlet: "Multi-outlet view", exitDemo: "Exit demo", currentPlan: "Current plan",
    // Landing
    navHow: "How it works", navPricing: "Pricing", navAbout: "About", heroEyebrow: "Data-led kitchen intelligence", heroTitle1: "Turn food waste", heroTitleEm: "into savings.", heroSub: "Wastelytics gives restaurants the visibility to understand waste, act on patterns, and keep more money on every plate.", startTrial: "Start free trial", joinNgo: "Join as NGO", heroProof: "Built for kitchens that care about every gram", ticketLabel: "WASTELYTICS / WEEKLY PULSE", ticketLive: "LIVE", ticketSavings: "EST. SAVINGS THIS MONTH", ticketChangeText: "18.4% less waste", ticketTrendLabel: "WASTE TREND · 8 WEEKS", loopKicker: "THE LOOP", loopTitle1: "Less waste is a", loopTitleSpan: "measurable advantage.",
    ...
    aboutKicker: "ABOUT WASTELYTICS", aboutTitle: "About", contentComingSoon: "Content coming soon.", aboutBackHome: "Back to home", logInBtn: "Log in", signUpBtn: "Sign up", signInAs: "Sign in as", founderTitle: "Founder, Wastelytics", founderTagline: "Building a data-driven path from food waste to food rescue.", aboutMissionLine: "Less waste. More reach. One dashboard at a time.", aboutCta: "See how it works", bySubscribingText: "By subscribing, you agree to our", trustKicker: "YOUR DATA, YOUR DECISIONS", trustLine: "Simple tools for more thoughtful kitchens.", termsLink: "Terms & conditions", termsKicker: "WASTELYTICS · TERMS", close: "Close", footerTagline: "Waste less. Know more.",
    // Portal-wide
  ...
  hi: {
    ...
    aboutKicker: "WASTELYTICS के बारे में", aboutTitle: "हमारे बारे में", contentComingSoon: "सामग्री जल्द आ रही है।", aboutBackHome: "होम पर वापस जाएं", logInBtn: "लॉग इन करें", signUpBtn: "साइन अप करें", signInAs: "इस रूप में साइन इन करें", founderTitle: "संस्थापक, Wastelytics", founderTagline: "भोजन की बर्बादी से भोजन बचाव तक का एक डेटा-आधारित रास्ता बनाना।", aboutMissionLine: "कम बर्बादी। अधिक पहुंच। एक समय में एक डैशबोर्ड।", aboutCta: "यह कैसे काम करता है देखें", bySubscribingText: "सदस्यता लेकर, आप हमारी सहमति देते हैं", trustKicker: "आपका डेटा, आपके निर्णय", trustLine: "अधिक विचारशील रसोई के लिए सरल उपकरण।", termsLink: "नियम व शर्तें", termsKicker: "WASTELYTICS · नियम", close: "बंद करें", footerTagline: "कम बर्बादी। अधिक जानकारी।",
